...
function faveColorFinder(color){
  ...
  }else console.log(`${color} you need to revaluate your favorite color choice`)
}
...
function thatsOdd(oddChecker){
  if(oddChecker % 2 === 0){
    console.log("Your number appears to be more even than odd")
  }else console.log("Your number is very odd")
}
